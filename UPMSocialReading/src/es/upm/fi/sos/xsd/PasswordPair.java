...
public class PasswordPair implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * PasswordPair Namespace URI = http://sos.fi.upm.es/xsd Namespace Prefix =
	 * ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":PasswordPair", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"PasswordPair", xmlWriter);
			}
						...
						if (!"PasswordPair".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (PasswordPair) es.upm.fi.sos.ExtensionMapper
